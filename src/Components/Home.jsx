...
const Home = () => {
    return (
        <div>
            <Header />
            <main id="home" className="duration-[0.3s] h-[46.5rem] pb-[5rem] home flex md:flex-row flex-col-reverse lg:p-[11rem] md:p-[4rem] sm:px-[6rem] p-[0.7rem] lg:justify-between md:justify-between items-center dark:bg-darkBG ">
